  ...
  "node_modules/b4a/lib/utf8.js"(exports, module) {
    ...
    if (typeof TextEncoder !== "undefined") {
      ...
      write = function write2(buffer, string) {
        return encoder2.encodeInto(string, buffer).written;
      };
    } else {
      write = function write2(buffer, string) {
        const len = buffer.byteLength;
...
var require_streamx = __commonJS({
  "node_modules/streamx/index.js"(exports, module) {
    ...
    var qmt = typeof queueMicrotask === "undefined" ? (fn) => globalThis.process.nextTick(fn) : queueMicrotask;
    var MAX = (1 << 29) - 1;
    var OPENING = 1;
    var PREDESTROYING = 2;
    var DESTROYING = 4;
...
var hex2bin = (hex) => {
  ...
  while (i < points.length) {
    res += String.fromCharCode.apply(null, points.subarray(i, i += MAX_ARGUMENTS_LENGTH));
  }
  return res;
};
var formatMap = {
...
function equal(a, b) {
  ...
  if ((a.byteOffset & 7) === 0 && (b.byteOffset & 7) === 0) {
    ...
    for (let j = 0; j < words; j++) {
      if (dvA.getBigInt64(j << 3) !== dvB.getBigInt64(j << 3))
        return false;
    }
  }
  const off = words << 3;
...
var Wire = class extends import_streamx.Duplex {
  ...
  async setEncrypt(sharedSecret, infoHash) {
    ...
    const keyAGenerator = new import_rc4.default([...await hash(hex2arr(this._utfToHex("keyA") + sharedSecret + infoHash))]);
    const keyBGenerator = new import_rc4.default([...await hash(hex2arr(this._utfToHex("keyB") + sharedSecret + infoHash))]);
...
*/
//# sourceMappingURL=chunk-SUKEFNKY.js.map
